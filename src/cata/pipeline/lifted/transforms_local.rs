    ...
    L::MapR: Clone + 'static,
{
    ...
    {
        self.apply_pre_lift(Local::filter_edges_lift::<L::N2, L::MapH, L::MapR, _>(pred))
    }
    ...
    where W: Fn(&L::N2, &mut dyn FnMut(&L::N2),
            ...
            + 'static,
    {
        self.apply_pre_lift(Local::wrap_visit_lift::<L::N2, L::MapH, L::MapR, _>(wrapper))
    }
    ...
    {
        self.apply_pre_lift(Local::memoize_by_lift::<L::N2, L::MapH, L::MapR, K, _>(key_fn))
    }

    // ── N-change (Stage-2 mirror of Stage-1 contramap_node) ──

    pub fn contramap_node_local<NewN, Co, Contra>(self, co: Co, contra: Contra)
    ...
    {
        self.apply_pre_lift(Local::contramap_n_lift::<L::N2, L::MapH, L::MapR, NewN, _, _>(co, contra))
    }
    ...
    {
        self.apply_pre_lift(Local::explainer_lift::<L::N2, L::MapH, L::MapR>())
    }

    // ── prepend_lift ──

    pub fn prepend_lift_local<L0>(self, first: L0) -> LiftedPipeline<Base, ComposedLift<L0, L>>
