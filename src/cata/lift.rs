...
/// type domain. The lifted computation runs internally; unwrap
/// recovers the original result type.
///
/// This is a natural transformation between algebras: it maps the
/// carrier types (N→N2, H→H2, R→R2), the algebra (Fold→Fold),
/// and the coalgebra (Treeish→Treeish) in lockstep.
